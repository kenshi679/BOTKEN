...
╔═ 〘 😳𝑲𝜩𝑵𝑰𝑺𝑯𝑰✰𝐃𝐔𝐒✰𝐇𝐘𝐏𝐄-BOT😳 〙══╗
╚════════════════════╝ 
╔ ═〘 Todos os usuários 〙═╗
🐒 *!nulis* [ Entrada de texto ]
🐒 *!sticker*
🐒 *!bhsjepang*
🐒 *!katabijak*
🐒 *!fakta*
...
🐒 *!sholat* [ nome da área ]
╚ ═════════════╝
╔ ═〘 informaçoes de comando 〙╗
🐒 *!ss*
🐒 *!wiki* 
🐒 *!brainly*
🐒 *!svc* [ etiqueta  ]
🐒 *!chord* [ o nome da musica ]
🐒 *!zodiak* 
🐒 *!listzodiak*
╚═════════════╝
╔〘 Entretenimento 〙╗
...
🐒 *!quotesnime*
🐒 *!nama*
🐒 *!pasangan* [ nome do parceiro l]
🐒 *!lirik* [ nome da música ]
🐒 *!infoig* [ nome ig ]
🐒 *!gay* [ marcar dois membros ]
🐒 *!buaya* [ tag orng ny ] 
🐒 *!bmkg*
╚═════════════╝
╔═〘 ᴅᴏᴡɴʟᴏᴀᴅᴇʀ ᴄᴏᴍᴍᴀɴᴅꜱ 〙╗
...
🐒 *!linkgroup*
╚═════════════╝
╔═〘 somente para o dono do bot  〙═╗
🐒 *!ban* - banido
🐒 *!bc* - promover
🐒 *!leaveall* - sair de todos os grupos
🐒 *!clearall* - deletar todos os chats
🐒 *!offbot* - desligue o barco
🐒 *!onbot* - culpe o barco
🐒 *!ressetbot* - reiniciar bot do sistema
╚═════════════╝

${gg} ${exists ? " exists " : "*Thank for Using 𝑲𝜩𝑵𝑰𝑺𝑯𝑰✰𝐃𝐔𝐒✰𝐇𝐘𝐏𝐄-BOT* 🤠"}
_#tetap jaga kesehatan_ ^_^`, MessageType.text)
conn.sendMessage(id, 'Menu VIP *!prouser*', MessageType.text)
}
...
🐒 *!onbot* - culpe o barco
🐒 *!ressetbot* - reiniciar bot do sistema
🐒 *!replay enable* - Repetir mensagem
🐒 *!replay disable* - Repetir mensagem
╚═════════════╝
${gg} ${exists ? " exists " : "*Thank for Using 𝑲𝜩𝑵𝑰𝑺𝑯𝑰✰𝐃𝐔𝐒✰𝐇𝐘𝐏𝐄-BOT* 🤠"}
_#tetap jaga kesehatan_ ^_^`, MessageType.text)
...
const exists = await conn.isOnWhatsApp (gg)
console.log(exists);
conn.sendMessage(id ,`╔ ═〘 *😳 ️𝑲𝜩𝑵𝑰𝑺𝑯𝑰✰𝐃𝐔𝐒✰𝐇𝐘𝐏𝐄-BOT😳 ️* 〙╗

*BAKAA!!* Bot tidak dapat join harus di lakukan secara manual/meminta kepada owner bot

${gg} ${exists ? " exists " : "*[ 𝑲𝜩𝑵𝑰𝑺𝑯𝑰✰𝐃𝐔𝐒✰𝐇𝐘𝐏𝐄-BOT ]* 🤠"}`, MessageType.text)
}
...
├≽️ !opengrup
╰─────────
${gg} ${exists ? " " : "*Thank for Using 𝑲𝜩𝑵𝑰𝑺𝑯𝑰✰𝐃𝐔𝐒✰𝐇𝐘𝐏𝐄-BOT* 🤠"}
_#tetap jaga kesehatan_ ^_^`, MessageType.text)
}
...
╰───────── ${gg} ${exists ? " " : "*Thank for Using 𝑲𝜩𝑵𝑰𝑺𝑯𝑰✰𝐃𝐔𝐒✰𝐇𝐘𝐏𝐄-BOT* 🤠"}`, MessageType.text)
}
